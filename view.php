...
/*	// AB - remove this block from here.. just for test
	echo 'uhhhhhhoooooooooo<br />'; // AB
...
//	echo ('<br />diffdays: '.$diffdays.'<br />');
	$disableddaysDB = $DB->get_record('facetoface', array('id'=>10)); // AB
//	var_dump($disableddaysDB);
...
*/
    ...
    if (!empty($previousarray)) {
        ...
        // AB
	echo ("this is inside Previous sessions in view.phpl");// AB
